...
$(document).ready(function() {
    ...
    // Initialize publish date checkbox state on page load
    var publishCheckbox = $('#publish-checkbox');
    var publishDate = $('#publish-date');
    
    if (publishCheckbox.is(':checked')) {
        // If checkbox is checked, ensure date input is enabled
        publishDate.prop('disabled', false);
    } else {
        // If checkbox is unchecked, ensure date input is disabled
        publishDate.prop('disabled', true);
    }
});
