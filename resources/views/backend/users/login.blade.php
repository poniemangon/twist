                    ...
                    <div class="sign-in">
                        <div class="row no-mrg-horizon">
                            <div class="col-md-6 no-pdd-horizon d-none d-md-block">
                                <div class="full-height bg" style="background: url({{ asset('public/backend/images/background.jpg') }}); background-size: cover; background-position: center;">
                                </div>
                            </div>
                                    ...
                                    <div class="vertical-align full-height pdd-horizon-70">
                                        <div class="table-cell">
                                            <div class="pdd-horizon-15">
                                                ...
                                                <p class="login-text">Log in to your account to manage your site.</p>
                                                ...
                                                <form method="post" action="{{ route('login-user') }}" id="user-login-form">
                                                    ...
                                                    <button class="btn btn-custom" id="user-login-button">Access</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
