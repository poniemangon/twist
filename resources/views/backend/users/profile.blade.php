    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="page-title col-md-9">
                ...
                <h4 class="section-title">User <span class="total-section-title-content">{{ $userData->name }} {{ $userData->surname }}</span></h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 ml-auto mr-auto">
                                ...
                                <form method="post" action="{{ route('edit-user', ['userId' => $userData->user_id]) }}" id="user-edition-form">
                                    ...
                                    <input type="hidden" name="is_user_profile" value="1">
