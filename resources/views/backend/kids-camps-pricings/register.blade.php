    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="page-title col-md-9">
                ...
                <h4 class="section-title">Kids Camps Pricings <span class="total-section-title-content">Create new pricing</span></h4>
                    ...
                    <div class="card-block">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 ml-auto mr-auto">
                                ...
                                <form method="post" action="{{ route('register-kid-camp-pricing') }}" id="kid-camp-pricing-registration-form">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-12 col-xs-12">
                                            ...
                                            <div class="text-right mrg-top-5 actions-buttons-group">
                                                ...
                                                <button type="submit" class="btn btn-custom btn-rounded mb-30 kid-camp-pricing-registration-button" data-saving-type="1">Save and keep editing</button>

                                                <button type="submit" class="btn btn-custom btn-rounded mb-30 kid-camp-pricing-registration-button" data-saving-type="2">Save</button>
