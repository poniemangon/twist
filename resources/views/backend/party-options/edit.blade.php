    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="page-title col-md-9">
                ...
                <h4 class="section-title">Party option <span class="total-section-title-content">Editar party option</span></h4>
                    ...
                    <div class="card-block">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 ml-auto mr-auto">
                                ...
                                <form method="post" action="{{ route('edit-party-option', ['partyOptionId' => $partyOptionData->party_option_id]) }}" id="party-option-edition-form">
                                    ...
                                    <div class="spanish-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" name="option_type" class="form-control" value="{{ $partyOptionData->option_type }}">
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" name="background_colour" class="form-control jscolor" value="{{ $partyOptionData->background_colour }}">
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <table class="table table-bordered table-stripped party-option-supplies-table-01">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @if (!empty($partyOptionData->twistSupplier) && count($partyOptionData->twistSupplier) > 0)

                                                            @foreach ($partyOptionData->twistSupplier as $twistSupplier)
                                                        
                                                                <tr>
                                                                    
                                                                    <td>
                                                                        
                                                                        <input type="text" class="form-control party-option-supply-01" value="{{ $twistSupplier->supply }}">
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <table class="table table-bordered table-stripped party-option-supplies-table-02">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @if (!empty($partyOptionData->customerSupplier) && count($partyOptionData->customerSupplier) > 0)

                                                            @foreach ($partyOptionData->customerSupplier as $customerSupplier)
                                                        
                                                                <tr>
                                                                    
                                                                    <td>
                                                                        
                                                                        <input type="text" class="form-control party-option-supply-02" value="{{ $customerSupplier->supply }}">
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <table class="table table-bordered table-stripped party-option-prices-table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @if (!empty($partyOptionData->prices) && count($partyOptionData->prices) > 0)

                                                            @foreach ($partyOptionData->prices as $price)
                                                        
                                                                <tr>

                                                                    <td>
                                                                        
                                                                        <input type="number" min="0" step="0.01" class="form-control party-option-price" value="{{ $price->price }}">

                                                                    </td>
                                                                    
                                                                    <td>
                                                                        
                                                                        <input type="text" class="form-control party-option-description" value="{{ $price->description }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <textarea class="form-control" id="long-description" name="description">{{ $partyOptionData->description }}</textarea>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-12 col-xs-12">
                                            ...
                                            <div class="text-right mrg-top-5 actions-buttons-group">
                                                ...
                                                <button type="submit" class="btn btn-custom btn-rounded mb-30 party-option-edition-button" data-saving-type="1">Save and keep editing</button>

                                                <button type="submit" class="btn btn-custom btn-rounded mb-30 party-option-edition-button" data-saving-type="2">Save</button>
