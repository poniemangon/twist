                ...
                <form id="article-search-form" method="get">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" name="search" autocomplete="off" value="{{ $filtersParameters['search'] ?? '' }}" placeholder="Enter article title...">
                        </div>
                        ...
                        <div class="col-lg-2">
                            ...
                            <select class="form-control" name="status">
                                ...
                                <option value="active" {{ ($filtersParameters['status'] ?? '') == 'active' ? 'selected' : '' }}>Active</option>
                                <option value="paused" {{ ($filtersParameters['status'] ?? '') == 'paused' ? 'selected' : '' }}>Paused</option>
                            </select>
                        </div>
                                    ...
                                    <tbody class="tbody">
                                        ...
                                        @foreach ($articles as $article)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $article->paused ? 'Paused' : 'Active' }}</td>
